...
<body>
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="img/smart.jpg" alt="Los Angeles" style="margin: auto;">
      <div class="container">
            <div class="carousel-caption">
						<div class="carousel-text">
            <h1  id="animated-example" class="animated bounceInRight" >BIENVENUE </h1>			
						  <ul>
			 <li  id="animated-example" class="animated bounceInLeft">SITE officiel de laboratoire de rechercher EECOMAS</li>
			 </ul>
     ...
     <?php
      ...
      {
      	echo "<div class='item'>
      <img src='../annonce/".$data['lien_image']."' alt='pas d image' style='margin: auto;'>
      <div class='container'>
            <div class='carousel-caption'>
						<div class='carousel-text'>";
