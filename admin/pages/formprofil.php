...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div>
			<!--HNAAYAAAA L CODE ------------------------------------------------------------------------------------------------------------------------->
                <form action="formprofil.php" method="post" enctype="multipart/form-data">
                    <fieldset><h3 style=" margin:35px; text-align: center;">Ajoutez un profil</h3></fieldset>
                        ...
                        <td><input type="email" name="emailprofil"></td></tr>
						<tr><td style="padding: 15px;"><label style="display: inline-block; width: 300px;">nouveau Mot de Passe</label></td>
                        <td><input type="text" name="password" required placeholder="par default azerty"></td></tr>
						...
						<tr><td style="padding: 15px;"><label style="display: inline-block; width: 300px;">Département</label></td>
							...
							<option value="1">	Informatique Logistique et Mathématiques</option>
							<option value="2">Génie Electrique, Réseaux et Systèmes de Télécommunication</option>
						</select>
							 </td></tr>
						<?php
						if($_SESSION['is_admin'] == 1) echo '<tr><td style="padding: 15px;"><label style="display: inline-block; width: 300px;">is_admin</label></td>';
                        echo '<td><input type="number" name="is_admin" value="0" min="0" max="1"></td></tr>';
						?>
				...
				<?php
					if(isset($_POST["envoyer"])){
						...
						$sql = "insert into enseignant(nom,prenom,description,email,image_ens,is_admin,id_dep) VALUES ('".$nom."','".$prenom."','".$description."','".$email."','".basename( $_FILES["imgprofil"]["name"])."',$is_admin,$id_dep)";
						$resultat = mysqli_query($link,$sql);
						//cree compte admin
						$cree_admin = "insert into admin(id_enseignant,email,password) VALUES ((select id_enseignant from enseignant where email='$email'),'$email',SHA('$password'))";
						$resultat_check = mysqli_query($link,$cree_admin);
